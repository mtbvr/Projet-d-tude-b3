...
export default function CGV(){
    return (
        <div className='text-white p-8 min-h-screen'>
            ...
            <p className="text-lg">Dernière mise à jour : [Date]</p>
            </div>
            ...
            <div className="mb-6">
            <h2 className="text-2xl font-semibold mb-2">1. Produits ou Services</h2>
            <p className="leading-relaxed">
                Les produits ou services proposés à la vente sur le Site sont ceux figurant sur le Site au jour de la consultation, dans la limite des stocks disponibles. Nous nous réservons le droit de modifier la sélection de produits ou services en fonction des contraintes liées à nos fournisseurs.
            </p>
            </div>
            ...
            <div className="mb-6">
            <h2 className="text-2xl font-semibold mb-2">3. Prix</h2>
            <p className="leading-relaxed">
                Les prix des produits ou services sont indiqués en [monnaie] et incluent la TVA applicable au moment de la commande. Les frais de livraison, de préparation et autres frais éventuels seront précisés avant la validation définitive de la commande.<br />
                Le vendeur se réserve le droit de modifier ses prix à tout moment, mais les produits ou services seront facturés au tarif en vigueur au moment de la commande.
            </p>
            </div>

            <div className="mb-6">
            <h2 className="text-2xl font-semibold mb-2">4. Modalités de paiement</h2>
            <p className="leading-relaxed">
                Le paiement de la commande peut être effectué par les moyens suivants :<br />
                [Carte bancaire]<br />
                [PayPal]<br />
                [Autre moyen de paiement]<br />
                Le paiement est exigible dès la validation de la commande. La commande sera considérée comme effective après réception du paiement intégral par le vendeur.
            </p>
            </div>
            ...
            <div className="mb-6">
            <h2 className="text-2xl font-semibold mb-2">10. Modification des CGV</h2>
            <p className="leading-relaxed">
                Nous nous réservons le droit de modifier les présentes CGV à tout moment. Toute modification prendra effet dès sa publication sur le Site. Il est conseillé de consulter régulièrement ces CGV pour prendre connaissance des dernières mises à jour.
            </p>
            </div>

            <div className="mb-6">
            <h2 className="text-2xl font-semibold mb-2">11. Loi applicable et résolution des litiges</h2>
            <p className="leading-relaxed">
                Les présentes Conditions Générales de Vente sont soumises au droit français. En cas de litige, nous nous engageons à chercher une solution amiable. À défaut, le litige sera soumis aux juridictions compétentes de [ville].
            </p>
            </div>
        </div>
    )
